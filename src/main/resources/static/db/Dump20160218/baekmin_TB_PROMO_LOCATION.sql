...
CREATE TABLE `TB_PROMO_LOCATION` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='프로모션지역정보';
...
INSERT INTO `TB_PROMO_LOCATION` VALUES (1,'110203',NULL,'',NULL,'anonymousUser','팔달구',1),(2,'110801','','','2015-12-01 19:52:47','anonymousUser','상록구',1),(3,'110602','','','2015-12-01 20:14:05','anonymousUser','일산동구',1),(4,'110202','','','2016-02-11 16:38:57','지점장','권선구',6),(5,'110402','','',NULL,'지점장','소사구',6);
