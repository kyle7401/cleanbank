...
CREATE TABLE `TB_PARTNER` (
  ...
  PRIMARY KEY (`PT_CD`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='공장정보';
...
INSERT INTO `TB_PARTNER` VALUES (1,'','','02-3456-7890','평택세탁공장',50,'02-1234-5678','2015-11-23 00:00:00','anonymousUser'),(2,'','','222','수원 세탁공장',10,'1234','2015-12-17 15:48:22','anonymousUser'),(3,'','','031-000-0000','행복재단',50,'031-000-0000','2015-12-28 18:01:04','(주)시냅스테크놀로지'),(4,'','','213124','테스트공장',12,'01032402442','2016-03-02 20:54:30','(주)시냅스테크놀로지'),(5,'','','02-000-0000','테스트공장',50,'02-388-1111','2016-03-10 16:52:47','(주)시냅스테크놀로지');
...
-- Dump completed on 2016-03-28 15:59:39
